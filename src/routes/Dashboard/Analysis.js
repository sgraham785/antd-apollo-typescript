          ...
          <Col {...topColResponsiveProps}>
            ...
            >
              <Trend flag="up" style={{ marginRight: 16 }}>
                Week over week<span className={styles.trendText}>12%</span>
              </Trend>
              <Trend flag="down">
                Day over Day<span className={styles.trendText}>11%</span>
              </Trend>
            </ChartCard>
          </Col>
          <Col {...topColResponsiveProps}>
              ...
              >
                <div style={{ padding: "0 24px" }}>
                  <TimelineChart
                    ...
                    titleMap={{ y1: "Traffic", y2: "Payment items" }}
                  />
                </div>
              </TabPane>
            ))}
